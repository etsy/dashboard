 ...
 */

 {
     ...
     $tsd->addMetric("avg:$graphDownSample-avg:rate:proc.stat.cpu{cluster=app,type=total}");
        ...
        
{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric("avg:$graphDownSample-avg:rate:proc.stat.cpu{cluster=app,type=total,host=*}");
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}
{
    $graphName = "Load Avg. last minute Aggregate - $graphDownSample";
    $tsd = new Tsd($graphTime);
    $tsd->addMetric("avg:$graphDownSample-avg:proc.loadavg.1min{cluster=app}");
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric("avg:$graphDownSample-avg:proc.loadavg.1min{cluster=app,host=*}");
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

 {
     ...
     $tsd->addMetric("avg:$graphDownSample-avg:rate:proc.stat.cpu{cluster=app,type=iowait}");
     $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
 }
        
{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric("avg:$graphDownSample-avg:rate:proc.stat.cpu{cluster=app,type=iowait,host=*}");
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}
