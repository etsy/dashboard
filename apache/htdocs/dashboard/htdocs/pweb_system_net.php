...
$title = "PWEB Tier Network Metrics";
        ...
        
{
    ...
    $tsd->addMetric('avg:rate:proc.net.bytes{cluster=pweb,host=*,direction=in}');
...

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:proc.net.bytes{cluster=pweb,host=*,direction=out}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.congestion.recovery{cluster=pweb,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.abort{cluster=pweb,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.packetloss.recovery{cluster=pweb,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.failed_accept{cluster=pweb,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}
