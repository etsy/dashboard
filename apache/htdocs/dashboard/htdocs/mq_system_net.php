        ...
        
{
    ...
    $tsd->addMetric('avg:rate:proc.net.bytes{cluster=mq,host=*,direction=in}');
...

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:proc.net.bytes{cluster=mq,host=*,direction=out}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.congestion.recovery{cluster=mq,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.abort{cluster=mq,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.packetloss.recovery{cluster=mq,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('avg:rate:net.stat.tcp.failed_accept{cluster=mq,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}
