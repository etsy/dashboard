        ...
        
{
    ...
    $tsd->addMetric('sum:rate:iostat.part.msec_total{cluster=app,host=*}');
...

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('sum:rate:iostat.disk.write_requests{cluster=app,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}

{
    ...
    $tsd = new Tsd($graphTime);
    $tsd->addMetric('sum:rate:iostat.disk.read_requests{cluster=app,host=*}');
    $template->addGraph($tsd->getDashboardHTML($graphWidth, $graphHeight), $graphName);
}
