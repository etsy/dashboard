...
{
    $graphName = "All Page Serve Time (ms) per serve- $perf_percent %th Percentile";
    $tsd = new Tsd($graphTime);
...
{
    $graphName = "/sales Page Serve Time (ms) per serve- $perf_percent %th Percentile";
    $tsd = new Tsd($graphTime);
...
{
    $graphName = "/product Page Serve Time (ms) per serve- $perf_percent %th Percentile";
    $tsd = new Tsd($graphTime);
...
{
    $graphName = "/add-to-cart-ajax.json Page Serve Time (ms) per serve- $perf_percent %th Percentile";
    $tsd = new Tsd($graphTime);
...
{
    $graphName = "DS Level 1 Page Serve Time (ms) per serve- $perf_percent %th Percentile";
    $tsd = new Tsd($graphTime);
